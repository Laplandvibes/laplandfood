...
const COPY: Record<Locale, Copy> = {
  en: {
    ...
    body: 'Lingonberry and cloudberry preserves, rye, Finnish coffee and salmiakki, the salted liquorice. Suomikauppa ships Finnish groceries worldwide, which is how Finns abroad restock. Dry and sealed goods travel; meat and dairy mostly do not leave the EU.',
    ...
    body: 'Puolukka- ja lakkahillot, ruis, suomalainen kahvi ja salmiakki. Suomikauppa toimittaa suomalaisia elintarvikkeita maailmanlaajuisesti, ja sitä kautta ulkosuomalaiset täydentävät kaappinsa. Kuivat ja suljetut tuotteet kulkevat; liha ja maito eivät useimmiten lähde EU:n ulkopuolelle.',
  ...
  de: {
    ...
    body: 'Preiselbeer- und Moltebeerkonfitüre, Roggen, finnischer Kaffee und Salzlakritz. Suomikauppa versendet finnische Lebensmittel weltweit, so füllen Finnen im Ausland ihre Vorräte auf. Trockene, verschlossene Ware reist; Fleisch und Milchprodukte verlassen die EU meist nicht.',
  ...
  ja: {
    ...
    body: 'コケモモやクラウドベリーのジャム、ライ麦、フィンランドのコーヒー、そしてサルミアッキ（塩味のリコリス）。Suomikauppa はフィンランドの食品を世界中へ発送しており、海外のフィンランド人はここで買い足します。乾いた密封品は問題なく届きますが、肉と乳製品はたいてい EU の外へは出られません。',
    worldwide: '世界中へ配送',
  ...
  es: {
    ...
    body: 'Mermeladas de arándano rojo y mora ártica, centeno, café finlandés y regaliz salado. Suomikauppa envía alimentos finlandeses a todo el mundo, y así reponen los finlandeses en el extranjero. Lo seco y sellado viaja; la carne y los lácteos casi nunca salen de la UE.',
  ...
  'pt-BR': {
    ...
    body: 'Geleias de airela e de amora-ártica, centeio, café finlandês e alcaçuz salgado. A Suomikauppa envia alimentos finlandeses para o mundo todo, e é assim que os finlandeses no exterior repõem o estoque. O que é seco e lacrado viaja; carne e laticínios quase nunca saem da UE.',
  ...
  'zh-CN': {
    ...
    body: '越橘酱与云莓酱、黑麦、芬兰咖啡，还有咸味甘草糖。Suomikauppa 把芬兰食品发往全球，旅居海外的芬兰人就是这样补货的。干燥密封的东西走得通；肉类与乳制品大多出不了欧盟。',
    worldwide: '全球配送',
  ...
  ko: {
    ...
    body: '링곤베리와 클라우드베리 잼, 호밀, 핀란드 커피, 그리고 짭짤한 감초 사탕. Suomikauppa는 핀란드 식품을 전 세계로 배송하며, 해외의 핀란드인들은 이렇게 채워 넣습니다. 마르고 밀봉된 것은 잘 가지만, 육류와 유제품은 대개 EU 밖으로 나가지 못합니다.',
    worldwide: '전 세계 배송',
  ...
  fr: {
    ...
    body: 'Confitures d’airelle et de mûre arctique, seigle, café finlandais et la réglisse salée. Suomikauppa expédie l’épicerie finlandaise dans le monde entier, et c’est ainsi que les Finlandais expatriés se réapprovisionnent. Le sec et le scellé voyagent ; la viande et les produits laitiers ne quittent presque jamais l’UE.',
  ...
  it: {
    ...
    body: 'Confetture di mirtillo rosso e mora artica, segale, caffè finlandese e la liquirizia salata. Suomikauppa spedisce alimentari finlandesi in tutto il mondo, ed è così che i finlandesi all’estero rifanno la scorta. Il secco e il sigillato viaggiano; carne e latticini non escono quasi mai dall’UE.',
  ...
  nl: {
    ...
    body: 'Vossenbes- en kruipbraamjam, rogge, Finse koffie en gezouten drop. Suomikauppa verstuurt Finse levensmiddelen wereldwijd, en zo vullen Finnen in het buitenland hun kast aan. Droog en verzegeld reist; vlees en zuivel komen meestal de EU niet uit.',
  ...
  sv: {
    ...
    body: 'Lingon- och hjortronsylt, råg, finskt kaffe och saltlakrits. Suomikauppa skickar finska matvaror över hela världen, och så fyller utlandsfinnar på skafferiet. Torrt och förslutet reser; kött och mejeri lämnar sällan EU.',
