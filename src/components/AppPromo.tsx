...
const COPY: Record<string, Copy> = {
  ...
  it: {
    ...
    features: [
      'Piste e impianti di nove stazioni sciistiche',
      'Colonnine per auto elettriche e distributori',
      'Sentieri, rifugi liberi e campeggi',
      ...
      'Numeri d’emergenza e farmacia più vicina',
    ],
    cta: 'Scarichi l’app gratis',
    scan: 'Inquadri il codice per aprire l’app sul telefono',
