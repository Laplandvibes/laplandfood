...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="bg-gradient-to-b from-[#002F6C] to-[#001F4A] py-20 sm:py-24 text-white">
            ...
            return (
              <div
                ...
                className={`rounded-2xl overflow-hidden transition-colors duration-300 border ${
                  isOpen
                    ? 'bg-white/10 border-vibe-pink/60'
              ...
              >
                ...
                >
                  <div className="flex items-start gap-4 flex-1 min-w-0">
                    <span className="font-heading tracking-wide text-lg text-vibe-pink shrink-0 leading-tight pt-0.5">
                  ...
                  <ChevronDown
                    className={`w-5 h-5 shrink-0 transition-transform duration-200 mt-1 ${
                      isOpen ? 'rotate-180 text-vibe-pink' : 'text-white/60'
                    }`}
                    aria-hidden="true"
                  />
                </button>
