...
export default function Home() {
  return <><SEO titleKey="home.title" descriptionKey="home.description" path={'/'} schema={homeSchema} /><div className="min-h-screen bg-white">
      ...
      <section className="bg-[#F8FAFC] py-20 sm:py-24">
        <div className="max-w-6xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {pillars.map(p => <Link key={p.href} to={p.href} className="group rounded-2xl bg-white border border-[#002F6C]/10 overflow-hidden hover:border-vibe-pink/40 hover:shadow-[0_8px_28px_rgba(0,47,108,0.08)] transition-all">
                <div className="aspect-[16/10] bg-gradient-to-br from-[#1A4A8A] via-[#002F6C] to-[#001F4A] relative overflow-hidden">
                  <img src={p.image} alt="" loading="lazy" decoding="async" onError={e => {
      ...
      <section className="relative bg-[#002F6C] py-20 sm:py-24 text-white overflow-hidden">
        <img src="/images/culture-band.jpg" alt="" loading="lazy" decoding="async" onError={e => {
          e.currentTarget.style.display = 'none';
        ...
        <div className="relative max-w-6xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {culturePoints.map(c => <div key={c.n} className="rounded-2xl bg-white/5 border border-white/15 p-7">
      ...
      <section className="relative overflow-hidden">
        <div className="relative py-20 sm:py-28 md:py-32">
          <img src="/images/midnight-sun-band.jpg" alt="" loading="lazy" decoding="async" onError={e => {
            e.currentTarget.style.display = 'none';
          ...
          <div className="relative max-w-5xl mx-auto px-5 sm:px-6 lg:px-8 text-center">
            ...
            <Link to="/foraging-guide" className="inline-flex items-center justify-center bg-white hover:bg-white/95 text-[#92400E] font-semibold px-7 py-3.5 rounded-full transition-colors text-base shadow-[0_4px_24px_rgba(0,0,0,0.25)]">
              What’s in season →
            </Link>
          </div>
        </div>
