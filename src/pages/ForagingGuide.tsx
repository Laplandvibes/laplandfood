          ...
          <div className="max-w-3xl mx-auto px-5 sm:px-6 lg:px-8">
            <div className="prose prose-lg max-w-none text-[#002F6C]/85">
              <p className="text-xl leading-relaxed font-medium text-[#002F6C] mb-6">
                {t('foragingGuide.intro.lead')}
              </p>
              <p className="leading-relaxed mb-5">{t('foragingGuide.intro.p1')}</p>
              <p className="leading-relaxed mb-5">
                <Trans i18nKey="foragingGuide.intro.p2" ns="pages" components={{ em: <em /> }} />
              </p>
              <p className="leading-relaxed mb-5">{t('foragingGuide.intro.p3')}</p>
              <p className="leading-relaxed">{t('foragingGuide.intro.p4')}</p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-3xl mx-auto px-5 sm:px-6 lg:px-8">
            ...
            <div className="prose prose-lg max-w-none text-white/85">
              <p className="leading-relaxed mb-6">
                <strong className="text-white">{t('foragingGuide.rights.canHeadline')}</strong>
              </p>
              <ul className="space-y-2 mb-6">
                {can.map((line, i) => <li key={i}>{line}</li>)}
              </ul>
              <p className="leading-relaxed mb-6">
                <strong className="text-white">{t('foragingGuide.rights.cannotHeadline')}</strong>
              </p>
              <ul className="space-y-2 mb-6">
                {cannot.map((line, i) => <li key={i}>{line}</li>)}
              </ul>
              <p className="leading-relaxed">{t('foragingGuide.rights.closing')}</p>
            </div>
          </div>
        </section>
