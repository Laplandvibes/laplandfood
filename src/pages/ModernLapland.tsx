...
const dishes = [{
  ...
  description: 'Classic reindeer cooked to 54 °C, served with wild bilberry sauce and beetroot crisps.',
  technique: 'Sous-vide',
  ...
  description: 'Lake whitefish cooked confit-style, meadowsweet, berry aïoli, and edible flowers.',
  ...
  description: 'A full dinner journey built around Lapland’s wild berries — from amuse-bouche to dessert.',
      ...
      <section className="bg-white py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-5">
            {dishes.map(d => <article key={d.name} className="group relative flex flex-col rounded-2xl bg-white border border-[#002F6C]/10 hover:border-vibe-pink/40 hover:shadow-[0_10px_32px_rgba(0,47,108,0.08)] transition-all overflow-hidden">
                <div className="relative h-72 bg-gradient-to-br from-[#1A4A8A] via-[#002F6C] to-[#001F4A] overflow-hidden">
                  <img src={d.image} alt="" loading="lazy" decoding="async" onError={e => {
      ...
      <section className="bg-[#F8FAFC] py-16 sm:py-20">
        <div className="max-w-3xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="space-y-5">
            ...
            }].map(tech => <div key={tech.t} className="rounded-2xl bg-white border border-[#002F6C]/10 p-6 sm:p-7">
